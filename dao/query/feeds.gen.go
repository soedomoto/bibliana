...
func newFeed(db *gorm.DB, opts ...gen.DOOption) feed {
	...
	_feed.LibraryID = field.NewInt32(tableName, "libraryID")
	_feed.Name = field.NewString(tableName, "name")
	_feed.URL = field.NewString(tableName, "url")
	_feed.LastUpdate = field.NewTime(tableName, "lastUpdate")
	_feed.LastCheck = field.NewTime(tableName, "lastCheck")
	_feed.LastCheckError = field.NewString(tableName, "lastCheckError")
	_feed.CleanupReadAfter = field.NewInt32(tableName, "cleanupReadAfter")
	_feed.CleanupUnreadAfter = field.NewInt32(tableName, "cleanupUnreadAfter")
	_feed.RefreshInterval = field.NewInt32(tableName, "refreshInterval")
...
type feed struct {
	...
	LastCheckError     field.String
	CleanupReadAfter   field.Int32
	CleanupUnreadAfter field.Int32
	RefreshInterval    field.Int32
...
func (f *feed) updateTableName(table string) *feed {
	...
	f.LibraryID = field.NewInt32(table, "libraryID")
	f.Name = field.NewString(table, "name")
	f.URL = field.NewString(table, "url")
	f.LastUpdate = field.NewTime(table, "lastUpdate")
	f.LastCheck = field.NewTime(table, "lastCheck")
	f.LastCheckError = field.NewString(table, "lastCheckError")
	f.CleanupReadAfter = field.NewInt32(table, "cleanupReadAfter")
	f.CleanupUnreadAfter = field.NewInt32(table, "cleanupUnreadAfter")
	f.RefreshInterval = field.NewInt32(table, "refreshInterval")
...
func (f *feed) fillFieldMap() {
	...
	f.fieldMap["libraryID"] = f.LibraryID
	f.fieldMap["name"] = f.Name
	f.fieldMap["url"] = f.URL
	f.fieldMap["lastUpdate"] = f.LastUpdate
	f.fieldMap["lastCheck"] = f.LastCheck
	f.fieldMap["lastCheckError"] = f.LastCheckError
	f.fieldMap["cleanupReadAfter"] = f.CleanupReadAfter
	f.fieldMap["cleanupUnreadAfter"] = f.CleanupUnreadAfter
	f.fieldMap["refreshInterval"] = f.RefreshInterval
}
