...
func newVersion(db *gorm.DB, opts ...gen.DOOption) version {
	...
	_version.Schema = field.NewString(tableName, "schema")
	_version.Version = field.NewInt32(tableName, "version")
...
func (v *version) updateTableName(table string) *version {
	...
	v.Schema = field.NewString(table, "schema")
