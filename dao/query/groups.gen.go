...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.GroupID = field.NewInt32(tableName, "groupID")
	_group.LibraryID = field.NewInt32(tableName, "libraryID")
	_group.Name = field.NewString(tableName, "name")
	_group.Description = field.NewString(tableName, "description")
	_group.Version = field.NewInt32(tableName, "version")
...
func (g *group) updateTableName(table string) *group {
	...
	g.GroupID = field.NewInt32(table, "groupID")
	g.LibraryID = field.NewInt32(table, "libraryID")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["libraryID"] = g.LibraryID
